...
<head>
    ...
    <title>Restaurant App Sale Receipt | {{$sale->id}}</title>
...
<div id="wrapper">
    <div id="receipt-header">
        <h3 id="restaurant-name">Restaurant App - RestGopal</h3>
        <address>
        Email-ID <a href="mailto:webmaster@example.com">Jon Doe</a>.<br>
        Tel: <a href="tel:0000000000">00-0000-0000</a><br>
        Visit us at: Example.com<br>
        Box 564, Disneyland<br>
        Gopalganj
        </address>
        <p>Reference Receipt: <strong>{{$sale->id}}</p>
    </div>
    <div id="receipt-body">
